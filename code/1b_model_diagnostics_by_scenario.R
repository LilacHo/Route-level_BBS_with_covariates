...
#
# This script reads the scenario manifest created by step 1, then evaluates the
...
here::i_am("code/1b_model_diagnostics_by_scenario.R")
...
if (!file.exists(manifest_file)) {
  stop("Scenario manifest not found. Run code/1_CH_no_habitat_routes.R first: ",
       manifest_file)
}
